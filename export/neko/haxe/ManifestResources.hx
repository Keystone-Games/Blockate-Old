...
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_eightbitdragon_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/EightBitDragon.ttf"; name = "Eight Bit Dragon"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_perfect_dos_vga_437_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Perfect DOS VGA 437.ttf"; name = "Perfect DOS VGA 437"; super (); }}


#else

@:keep @:expose('__ASSET__assets_fonts_eightbitdragon_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_eightbitdragon_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/EightBitDragon.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Eight Bit Dragon"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_perfect_dos_vga_437_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_perfect_dos_vga_437_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/Perfect DOS VGA 437.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Perfect DOS VGA 437"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_fonts_eightbitdragon_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_eightbitdragon_ttf extends openfl.text.Font { public function new () { name = "Eight Bit Dragon"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_perfect_dos_vga_437_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_perfect_dos_vga_437_ttf extends openfl.text.Font { public function new () { name = "Perfect DOS VGA 437"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__assets_fonts_eightbitdragon_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_eightbitdragon_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/EightBitDragon.ttf"; name = "Eight Bit Dragon"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_perfect_dos_vga_437_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_perfect_dos_vga_437_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Perfect DOS VGA 437.ttf"; name = "Perfect DOS VGA 437"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
